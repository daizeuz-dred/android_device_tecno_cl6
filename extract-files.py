...
blob_fixups: blob_fixups_user_type = {
    ...
    ('vendor/lib64/mt6789/libneuralnetworks_sl_driver_mtk_prebuilt.so', 'vendor/lib64/nfc_nci.thn31nfc.tms.so', 'vendor/lib64/tms-utils.so', 'vendor/lib64/libstfactory-vendor.so', 'vendor/lib64/libnvram.so', 'vendor/lib/libsysenv.so', 'vendor/lib64/libsysenv.so', 'vendor/lib64/libtflite_mtk.so', 'vendor/lib64/nfc_nci_nxp_snxxx.so'): blob_fixup()
    ...
    ('vendor/lib64/mt6789/libtranssion_bodybeauty.so', 'vendor/lib64/mt6789/libeffect_hal.so', 'vendor/lib64/libvideofilmeffect.so', 'vendor/lib64/libapuwareutils_v2.mtk.so', 'vendor/lib64/mt6789/libsegmentionPre.so'): blob_fixup()
        .clear_symbol_version('AHardwareBuffer_allocate')
        .clear_symbol_version('AHardwareBuffer_createFromHandle')
        .clear_symbol_version('AHardwareBuffer_describe')
        .clear_symbol_version('AHardwareBuffer_getNativeHandle')
    ...
    'vendor/lib64/librt_extamp_intf.so': blob_fixup()
        .replace_needed('libtinyxml2.so', 'libtinyxml2-v34.so'),
    'vendor/lib64/mt6789/libsegmention.so': blob_fixup()
        .add_needed('libtflite_native_gainference.so'),
}  # fmt: skip 
